...
def migrate():
    ...
    try:
        ...
        try:
            ...
            db.commit()
            logger.info("âœ“ pg_stat_statements extension available")
        except Exception as e:
            logger.warning(f"âš  pg_stat_statements unavailable: {e}")
        ...
        try:
            ...
            db.commit()
            logger.info("âœ“ Query logging enabled (slow queries > 100ms will be logged)")
        except Exception as e:
            logger.warning(f"âš  Query logging configuration: {e}")
        ...
        logger.info(f"\nâœ“ Created {index_count} indexes")
        
        # Step 6: Analyze tables
        logger.info("\nStep 6: Analyzing tables (updating statistics)...")
        db.execute(text("ANALYZE"))
        db.commit()
        logger.info("âœ“ Table analysis complete")
        ...
        logger.info(f"âœ“ Database size: {total_size}")
        ...
        logger.info(f"âœ“ Total indexes: {index_count}")
        
        # Step 9: Success message
        log_section("âœ“ MIGRATION SUCCESSFUL")
        
        logger.info("Summary:")
        logger.info("  âœ“ Query logging enabled (queries > 100ms logged)")
        logger.info(f"  âœ“ {index_count} strategic indexes created")
        logger.info("  âœ“ Table statistics updated")
        logger.info("  âœ“ Database ready for Phase 3")
        ...
        log_section("âœ— MIGRATION FAILED")
