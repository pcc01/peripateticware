...
const teacherScreens: CarouselScreen[] = [
{
  emoji: '🏗️',
  title: 'Build Activity',
  subtitle: '7 steps to launch',
  backgroundColor: '#eaf2ec',
  prompt: 'Ready to create your first activity?',
  response: 'Name • Location • Standards • 3-Phase Prompts • Publish'
},
{
  emoji: '📊',
  title: 'View Submissions',
  subtitle: 'See student evidence real-time',
  backgroundColor: '#eaf2ec',
  prompt: 'What are your students capturing?',
  response: '15 photos, 3 videos submitted • All tagged by standard'
},
{
  emoji: '✅',
  title: 'Grade by Rubric',
  subtitle: 'Standards-aligned assessment',
  backgroundColor: '#eaf2ec',
  prompt: 'How will you assess?',
  response: 'Use built-in rubric • Auto-generate report • Share with admin'
}];
  ...
  return (
    <div className="ttp-page">
      ...
      <section className="ttp-hero">
        <div className="ttp-container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <PhoneCarousel screens={teacherScreens} personaColor="#e8f5e9" />
          </div>
        </div>
      </section>
