  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <button onClick={() => navigate('/teacher/activities')} className={styles.backBtn}>{t("landing:back_to_dashboard", "\u2190 Back to Dashboard")}
      ...
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.settingGroup}>
            <label className={styles.checkboxLabel}>
              <input
                ...
                onChange={(e) => handleChange('autoSaveEnabled', e.target.checked)} />{t("landing:autosave_activity_drafts", "Auto-save Activity Drafts")}
          ...
          <div className={styles.settingGroup}>
            <label className={styles.checkboxLabel}>
              <input
                type="checkbox"
                checked={settings.studentNotificationsEnabled}
                onChange={(e) => handleChange('studentNotificationsEnabled', e.target.checked)} />{t("landing:notify_students_of_feedback", "Notify Students of Feedback")}
        ...
        <section className={styles.section} style={{ borderColor: '#dc2626' }}>
          ...
          <button onClick={handleLogout} className={styles.dangerBtn}>{t("landing:teachersettingspage.logout", "\uD83D\uDEAA Logout")}
