      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white rounded-lg p-8 shadow">
        ...
        <div className="border-b border-gray-200 pb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Bloom's Level */}
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">{t("landing:blooms_taxonomy_level", "Bloom's Taxonomy Level")}
        ...
        <div className="border-b border-gray-200 pb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">{t("landing:location_information", "Location Information")}</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">{t("landing:activitymanager.latitude", "Latitude")}
              ...
              <input
                ...
                placeholder={t("landing:eg_476839", "e.g., 47.6839")} />
              
              {errors.location_latitude && <p className="text-red-500 text-sm mt-1">{errors.location_latitude}</p>}
            </div>

            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">{t("landing:activitymanager.longitude", "Longitude")}
              ...
              <input
                ...
                placeholder={t("landing:eg_1223081", "e.g., -122.3081")} />
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder={t("landing:eg_downtown_park_science_museum", "e.g., Downtown Park, Science Museum")} />
            
          </div>

          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2 mt-4">{t("landing:location_radius_meters", "Location Radius (meters)")}
        ...
        <div className="border-b border-gray-200 pb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">{t("landing:learning_objectives", "Learning Objectives")}</h2>
        ...
        <div className="pb-6">
          ...
          <div className="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50">
            ...
            <label htmlFor="shareable" className="ml-3 text-sm font-semibold text-gray-700 cursor-pointer flex-1">{t("landing:make_this_activity_shareable_with_other_", "Make this activity shareable with other teachers")}
