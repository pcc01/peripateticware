...
Peripateticware is dual licensed under the **Business Source License 1.1 (BSL 1.1)** and Apache 2.0.
All contributions are made under the [Dual License](LICENSE_DUAL.md):
...
- The license fully converts to **Apache 2.0** (fully open-source) on **May 1, 2030**
...
- Run it on your own servers or in the cloud for your organization's use
...
Technically, **no** — it's "source-available" (you can see the code but have restrictions) but all contributions are made under the Apache 2.0 license.
...
- Prevents 3p commoditization while ensuring future openness
